...
$produtosPorPagina = 6; // Número de produtos por página
$query = isset($_GET['query']) ? trim($_GET['query']) : '';
$paginaAtual = isset($_GET['pagina']) ? (int)$_GET['pagina'] : 1;

// Filtrar produtos com base na pesquisa (somente por nome e tipo)
$produtosFiltrados = array_filter($produtos, function ($produto) use ($query) {
    return stripos($produto['nome'], $query) !== false;
    // || stripos($produto['tipo'], $query) !== false;
});
...
// Ajustar a página atual
if ($paginaAtual < 1) $paginaAtual = 1;
if ($paginaAtual > $totalPaginas) $paginaAtual = $totalPaginas;

// Calcular índices de produtos para exibição
$inicio = ($paginaAtual - 1) * $produtosPorPagina;
$fim = $inicio + $produtosPorPagina;

// Produtos a serem exibidos na página atual
$produtosPagina = array_slice($produtosFiltrados, $inicio, $produtosPorPagina);
...
<body>
    ...
    <div class="container">
      <div class="row align-items-end text-center">
        <div class="col-lg-7 mx-auto">
          <h1>Loja</h1>  
          <p class="mb-4"><a href="index.php">Início</a> / <strong>Loja</strong></p>        
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="untree_co-section pt-3">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <ul class="list-unstyled categories">
            <li><a href="shop.php?query=bota&pagina=1">Botas <span>2,919</span></a></li>
            <li><a href="shop.php?query=relógio&pagina=1">Relógios <span>5,381</span></a></li>
            <li><a href="shop.php?query=Tênis&pagina=1">Tênis <span>7,119</span></a></li>
          </ul>
        </div>
        <div class="col-md-9">
          <div class="row">
            ...
            <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
              <div class="product-item">
                <a class="product-img">
                  ...
                  <img src="<?php echo $produto['image']; ?> "   alt="<?php echo $produto['nome']; ?> "  class="img-fluid">
                </a>
                <h3 class="title"><a href="#"><?php echo $produto['nome']; ?> </a></h3>
                <div class="price">
                  <span> <?php echo number_format($produto['preco'], 2); ?></span>
                </div>
                <p class="mb-2" data-aos="fade-up" data-aos-delay="300"><a href="?adicionar=<?php echo $produto['id']; ?>" class="btn btn-outline-black">Add Carrinho</a></p>
                <p class="mb-0" data-aos="fade-up" data-aos-delay="300"><a onclick="redirecionarParaDetalhes(<?php echo $produto['id']; ?>)" class="btn btn-black">Ver Detalhes</a></p>
        ...
        <div>
            <?php if ($paginaAtual > 1) { ?>
                 <a href="shop.php?pagina=<?php echo $paginaAtual - 1; ?>&query=<?php echo urlencode($query); ?> " class="btn btn-outline-black">Anterior</a>
            <?php } ?>
            <?php if ($paginaAtual < $totalPaginas) { ?>
                <a href="shop.php?pagina=<?php echo $paginaAtual + 1; ?>&query=<?php echo urlencode($query); ?>" class="btn btn-outline-black">Próximo</a>
            <?php } ?>
        </div>
      </div>
    </div> 
    ...
    <script>
		function redirecionarParaDetalhes(produtoId) {
...
<script>
		...
		window.addEventListener('load', function() {
			...
			if (savedPosition) {
				window.scrollTo(200, savedPosition);
			}
		});
	</script>
  </body>

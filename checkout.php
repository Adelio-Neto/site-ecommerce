    ...
    <div class="container">
      <div class="row align-items-end text-center">
        <div class="col-lg-7 mx-auto">
          <h1>Checkout</h1>  
          <p class="mb-4"><a href="cart.php">Voltar</a> / <strong>Checkout</strong></p>        
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mb-5 mb-md-0">
          <h2 class="h3 mb-3 text-black">Preencher com Dados </h2>
          <div class="p-3 p-lg-5 border">

          <form action="php/whatsapp.php" method="post">
            ...
            <div class="form-group row">
              <div class="col-md-12">
                <label for="c_companyname" class="text-black">Enderenço </label>
                <input type="text" class="form-control" id="endereco" name="endereco" required>
              </div>
            </div>

            <div class="form-group">
                  <button class="btn btn-black btn-lg py-3 btn-block">Enviar Pedido</button>
            </div>
        ...
        <div class="col-md-6">
          ...
          <div class="row mb-5">
            <div class="col-md-12">
              <h2 class="h3 mb-3 text-black">Produtos Selecionados</h2>
              <div class="p-3 p-lg-5 border">
                <table class="table site-block-order-table mb-5">
                  ...
                  <?php foreach ($_SESSION['carrinho'] as $id => $produto): ?>
                    <tr>
                      <td><?php echo htmlspecialchars($produto['nome']); ?><strong class="mx-2">x</strong><?php echo $produto['quantidade']; ?></td>
                      <td><?php echo number_format($produto['preco'] * $produto['quantidade'], 2); ?> KZ</td>
                    </tr>
                    <?php endforeach; ?>
                    <tr>
                      <td class="text-black font-weight-bold"><strong>Preço Total</strong></td>
                      <td class="text-black "><strong><?php echo number_format(quantidadeTotalDeDinheiro(), 2); ?> KZ</strong></td>
                    </tr>
                  </tbody>

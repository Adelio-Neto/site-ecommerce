				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							...
							<h1 class="mb-4 heading" data-aos="fade-up" data-aos-delay="100">Compre os teus produtos de forma fácil com Risuu.store<a href="#"></a></h1>
							<div class="mb-5 text-white desc mx-auto" data-aos="fade-up" data-aos-delay="200">
							</div>

							<p class="mb-0" data-aos="fade-up" data-aos-delay="300"><a href="#" class="btn btn-outline-black">Comprar Agora</a></p>
				...
				<?php foreach ($produtos as $id => $produto): ?>
					<div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
						<div class="product-item">
							...
							<p class="mb-2" data-aos="fade-up" data-aos-delay="300"><a href="?adicionar=<?php echo $id; ?>" onclick="return confirm('Tem certeza que deseja adicionar este produto?');" class="btn btn-outline-black">Add Carrinho</a></p>
							<p class="mb-0" data-aos="fade-up" data-aos-delay="300"><a onclick="redirecionarParaDetalhes(<?php echo $id; ?>)" class="btn btn-black">Ver Detalhes</a></p>
		...
		<div class="container">
			...
			<div class="row mt-5">
				...
				<div class="col-12 text-center copyright">
					<p>Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; Designed with love by <a href="#">Untree.co</a> <!-- License information: #/license/ -->
					</p>
